...
xst -ifn xst.scr
move SuperCoolClk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\SuperCoolClk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc SuperCoolClk_exdes.ucf SuperCoolClk_exdes

echo 'Running map'
map -timing -pr b SuperCoolClk_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm SuperCoolClk_exdes -w routed.ncd routed.v
cd ..
